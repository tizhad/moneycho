...
const COSTS_TABLE = {
  en: [
    { item: 'Transfer tax (overdrachtsbelasting)', who: 'Fixed', amount: '2% of purchase price (0% starter < 35 yr, ≤ €555K)' },
    ...
    { item: 'NHG guarantee fee', who: 'Fixed', amount: '0.4% of mortgage (if ≤ €470K)' },
  ...
  nl: [
    { item: 'Overdrachtsbelasting', who: 'Vast', amount: '2% van koopprijs (0% starter < 35 jr, ≤ € 555K)' },
    ...
    { item: 'NHG borgtochtprovisie', who: 'Vast', amount: '0,4% van hypotheek (bij ≤ € 470K)' },
...
const EDITORIAL = {
  en: {
    ...
    whatP2:
      "The single largest cost is usually transfer tax (overdrachtsbelasting) at 2%. First-time buyers under 35 purchasing a home up to €555,000 are exempt — a saving that can be worth €7,000–€11,100 at typical Amsterdam prices.",
    ...
    starterP1:
      "First-time buyers under 35 pay 0% transfer tax on homes up to €555,000 (2026 limit). On a €350,000 home, that saves you €7,000. On a home at the limit, it saves €11,100.",
    starterP2:
    ...
    nhgP1:
      "NHG (Nationale Hypotheek Garantie) is a government-backed guarantee on mortgages up to €470,000 (2026). It has two benefits: lenders typically offer 0.4–0.7% lower rates to NHG borrowers, and if you are ever forced to sell at a loss, NHG covers the residual debt.",
    nhgP2:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'First-time buyers under 35 pay 0% transfer tax instead of 2%, but only if the purchase price does not exceed €555,000 (2026 limit). You can only use this exemption once in your life. The saving equals 2% of the purchase price — up to €11,100 at the limit.',
      },
      {
      ...
      },
      {
        ...
        a: 'NHG (Nationale Hypotheek Garantie) is a government guarantee on mortgages up to €470,000 (2026). It lowers your interest rate by roughly 0.4–0.7% and protects you if you must sell at a loss. The one-off fee is 0.4% of your mortgage. For most buyers under the limit, NHG is worth it.',
      },
    ],
  },
  nl: {
    ...
    whatP2:
      'De grootste eenmalige kostenpost is doorgaans de overdrachtsbelasting van 2%. Starters jonger dan 35 jaar die een woning kopen tot € 555.000 zijn hiervan vrijgesteld — bij een woning van € 350.000 scheelt dat € 7.000.',
    ...
    starterP1:
      'Starters jonger dan 35 jaar betalen 0% overdrachtsbelasting op woningen tot € 555.000 (grens 2026). Op een woning van € 350.000 bespaar je daarmee € 7.000. Op een woning aan de grens bespaar je maximaal € 11.100.',
    starterP2:
    ...
    nhgP1:
      'NHG (Nationale Hypotheek Garantie) is een overheidsgarantie op hypotheken tot € 470.000 (grens 2026). Het heeft twee voordelen: geldverstrekkers bieden NHG-hypotheken doorgaans 0,4–0,7% lagere rente, en bij gedwongen verkoop met restschuld wordt die schuld door NHG kwijtgescholden.',
    nhgP2:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Starters jonger dan 35 jaar betalen 0% overdrachtsbelasting in plaats van 2%, maar alleen als de koopprijs niet hoger is dan € 555.000 (grens 2026). Je kunt de vrijstelling maar één keer in je leven gebruiken. De besparing is gelijk aan 2% van de koopprijs — maximaal € 11.100 aan de grens.',
      },
      {
      ...
      },
      {
        ...
        a: 'NHG (Nationale Hypotheek Garantie) is een overheidsgarantie op hypotheken tot € 470.000 (grens 2026). Het verlaagt je rente met circa 0,4–0,7% en beschermt je bij gedwongen verkoop met restschuld. De eenmalige borgtochtprovisie is 0,4% van de hypotheek. Voor de meeste kopers onder de grens is NHG de moeite waard.',
      },
    ],
  },
} as const;
