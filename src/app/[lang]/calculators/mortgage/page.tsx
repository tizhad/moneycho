...
const EDITORIAL = {
  en: {
    ...
    nlRatesP2: 'NHG is worth getting if your loan falls below the threshold (€470,000 in 2026). It reduces your interest rate by roughly 0.5 to 0.7 percentage points and protects you if you are forced to sell at a loss.',
    ...
    faqs: [
      ...
      ['What is NHG and do I qualify?', 'NHG (Nationale Hypotheek Garantie) is a government-backed guarantee on mortgages below €470,000 (2026 limit). It lowers your interest rate by 0.5–0.7% and protects you if you must sell at a loss. Most first-time buyers in the Netherlands qualify. Your lender or hypotheekadviseur can confirm eligibility.'],
      ['What is hypotheekrenteaftrek?', 'Hypotheekrenteaftrek is Dutch mortgage interest tax deductibility. You can deduct the interest you pay on your mortgage from your taxable income, which reduces your effective interest cost. It applies for up to 30 years and only to your primary residence. The deduction rate has been gradually reduced and is capped at 37.56% in 2026.'],
    ...
    maxTwoP1: 'Since 2023, both incomes are counted at 100% in Dutch mortgage calculations. Two partners each earning €40,000 can borrow approximately what someone earning €80,000 would — around €340,000–€360,000 indicatively. Check the NIBUD tables for your exact combined income.',
  ...
  nl: {
    ...
    nlRatesP2: 'NHG (Nationale Hypotheek Garantie) is de moeite waard als je hypotheek onder de kostengrens van € 470.000 valt (2026). Het verlaagt je rente met circa 0,5 tot 0,7 procentpunt en beschermt je bij een gedwongen verkoop met restschuld.',
    ...
    faqs: [
      ...
      ['Wat zijn bijkomende kosten bij het kopen van een huis?', 'Naast de koopprijs betaal je bij aankoop van een bestaand huis 2% overdrachtsbelasting (starters tot 35 jaar met woning ≤ € 555.000 betalen 0%), notariskosten (ca. € 1.000–2.000), taxatiekosten (ca. € 500–800) en eventueel makelaarskosten. Reken op 3%–6% kosten koper bovenop de koopprijs.'],
    ] as [string, string][],
    ...
    maxTwoP1: 'Sinds 2023 wordt het tweede inkomen voor 100% meegeteld bij de hypotheekberekening. Twee partners die elk € 40.000 verdienen kunnen indicatief lenen wat iemand met een inkomen van € 80.000 zou kunnen — circa € 340.000–€ 360.000. Raadpleeg de NIBUD-tabellen voor jouw exacte gecombineerde inkomen.',
