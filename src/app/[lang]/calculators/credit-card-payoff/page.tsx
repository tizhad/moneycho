...
const COPY = {
  en: {
    ...
    description:
      'Find out how long to pay off your credit card balance and how much interest you will pay. Beat the minimum payment trap.',
  },
  nl: {
    title: 'Creditcard Aflossen Calculator',
    description:
      'Bereken hoe lang het duurt om je creditcardsaldo af te lossen en hoeveel rente je betaalt. Ontsnap aan de minimumaflossingsval.',
  },
} as const;
